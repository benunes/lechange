...
import {ArrowLeft, Clock, Euro, Flag, Heart, Share, Sparkles, Tag, User,} from "lucide-react";
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    {listing.images.length > 0 ? (
                        <>
                            <Card
                                className="border-0 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm shadow-xl overflow-hidden">
                        ...
                        <Card
                            className="border-0 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/20 backdrop-blur-sm">
                            <CardContent className="flex items-center justify-center h-96">
                                <div className="text-center">
                                    <div
                                        className="h-16 w-16 bg-gradient-to-r from-orange-100 to-amber-100 dark:from-orange-900/20 dark:to-amber-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <div className="space-y-6">
                    ...
                    <Card className="border-0 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm shadow-xl">
                        <CardHeader>
                            <div className="flex items-start justify-between mb-4">
                                <div
                                    className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/10 to-amber-500/10 border border-orange-200/20 rounded-full px-4 py-2">
                                    <Tag className="h-4 w-4 text-orange-500"/>
                                    <span
                                        className="text-sm font-medium bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">
                    Annonce
                  </span>
                                </div>
                                {!isOwner && (
                            ...
                            <div className="flex items-center gap-4">
                                <div className="relative">
                                    {listing.createdBy.image ? (
                                        ...
                                        <div
                                            className="h-12 w-12 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-full flex items-center justify-center">
                                            <User className="h-6 w-6 text-purple-500"/>
                                        </div>
                                    )}
                                    <div
                                        className="absolute -bottom-1 -right-1 h-4 w-4 bg-green-500 border-2 border-white dark:border-gray-800 rounded-full"></div>
                                </div>
                    ...
                    {!isOwner && session ? (
                        ...
                        <Card
                            className="border-0 bg-gradient-to-br from-blue-50/50 to-cyan-50/50 dark:from-blue-950/10 dark:to-cyan-950/10 backdrop-blur-sm shadow-lg">
                            <CardContent className="text-center p-6">
                                <h3 className="text-lg font-semibold mb-2">C'est ton annonce !</h3>
