...
import {getNewerMessages} from "@/lib/actions/messages.actions";
...
export function ChatView({
    ...
    useEffect(() => {
        const interval = setInterval(async () => {
            ...
            if (lastMessage) {
                const newMessages = await getNewerMessages(
                    conversationId,
    ...
    return (
        <div className="flex flex-col h-full">
            {/* Messages Container */}
            <div
                className="flex-1 overflow-y-auto p-4 bg-gradient-to-b from-slate-50/50 to-blue-50/50 dark:from-slate-900/50 dark:to-blue-950/50">
                {messages.length === 0 ? (
                    <motion.div
                    ...
                    >
                        <div className="text-center">
                            <div
                                className="h-16 w-16 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                            ...
                                            <div className="flex-shrink-0">
                                                {message.sender.image ? (
                                                    ...
                                                    >
                                                        <User
                                                            className={`h-4 w-4 ${
                                                                isCurrentUser ? "text-purple-500" : "text-blue-500"
                                                            }`}
                                                        />
                                                    </div>
                                                )}
