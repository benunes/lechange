...
import {HelpCircle, LogOut, MessageSquare, PlusCircle, Sparkles, UserCircle, Zap,} from "lucide-react";
...
export function Header() {
    ...
    return (
        <TooltipProvider>
            ...
            >
                <div
                    className="w-full flex h-20 items-center justify-between px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24">
                    <motion.div
                    ...
                    >
                        <Link href="/" className="flex items-center gap-3 group">
                            <div className="relative">
                                ...
                                />
                                <div
                                    className="relative bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 p-2 rounded-full">
